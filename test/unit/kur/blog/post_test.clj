...
(deftest file-info-regression-test
  ...
  (is (= (mapv file-info (sort (fs/list-dir "test/fixture/blog-v1-md")))
         [#:kur.blog.post{:id "kur2004250001",
                          ...
                          :public? nil,
                          :md-path "test/fixture/blog-v1-md/kur2004250001.-.오버 띵킹의 함정을 조심하라.md",
                          ;:exists? true,
                          :last-modified-millis 1649905086389}
          #:kur.blog.post{:id "kur2205182112",
                          :title ".인간의 우열(편차)보다 사용하는 도구와 환경, 문화의 우열이 퍼포먼스에 더 큰 영향을 미친다",
                          :public? nil,
                          :md-path "test/fixture/blog-v1-md/kur2205182112..인간의 우열(편차)보다 사용하는 도구와 환경, 문화의 우열이 퍼포먼스에 더 큰 영향을 미친다.md",
                          ;:exists? true,
                          :last-modified-millis 1658968984405}
          #:kur.blog.post{:id "kur2206082055",
                          :title "Clojure 1.10의 tap은 디버깅 용도(better prn)로 사용할 수 있다",
                          :public? nil,
                          :md-path "test/fixture/blog-v1-md/kur2206082055.Clojure 1.10의 tap은 디버깅 용도(better prn)로 사용할 수 있다.md",
                          ;:exists? true,
          ...
          #:kur.blog.post{:id "kur2207161305",
                          ...
                          :public? true,
                          :md-path "test/fixture/blog-v1-md/kur2207161305.+.kill-current-sexp의 Emacs, VSCode 구현.md",
                          ;:exists? true,
                          :last-modified-millis 1656926109907}
          #:kur.blog.post{:id "kur2207281052",
                          :meta-str "+",
                          :public? true,
                          :md-path "test/fixture/blog-v1-md/kur2207281052.+.md",
                          ;:exists? true,
